    ...
    >
      <div className="flex min-w-0 items-center gap-2.5">
        ...
        <div className="min-w-0">
          <p className="truncate text-base font-bold tracking-tight text-foreground">Community</p>
          <p className="truncate text-[11px] text-muted-foreground">Wellness groups</p>
        </div>
      </div>
